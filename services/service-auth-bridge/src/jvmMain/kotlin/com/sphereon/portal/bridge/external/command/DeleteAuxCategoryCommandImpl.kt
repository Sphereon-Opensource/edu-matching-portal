...
import com.sphereon.portal.bridge.external.DeleteAuxCategoryCommand
...
@ContributesBinding(SessionScope::class, binding = binding<DeleteAuxCategoryCommand>())
class DeleteAuxCategoryCommandImpl(
    ...
    id = DeleteAuxCategoryCommand.COMMAND_ID,
    execution = execution,
    endpoint = DeleteAuxCategoryCommand.ENDPOINT,
    ...
    override suspend fun doExecute(
        ...
        // Reject operations on soft-deleted identities
        ...
        auxiliaryDataService.delete(auth.tenantId, decrypted.first().id)
