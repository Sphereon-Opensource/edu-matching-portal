...
import com.sphereon.portal.bridge.external.GetIdentityCommand
...
@ContributesBinding(SessionScope::class, binding = binding<GetIdentityCommand>())
class GetIdentityCommandImpl(
    ...
    id = GetIdentityCommand.COMMAND_ID,
    execution = execution,
    endpoint = GetIdentityCommand.ENDPOINT,
), GetIdentityCommand {
